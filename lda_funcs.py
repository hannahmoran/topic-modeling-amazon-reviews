...
def run_lda(df, product, n_topics, n_passes, texts, save_path):
    ...
    :rtype: DataFrame 
    """
    os.remove('training_output.log') # clear the log file
        ...
        for na in n_above:
            ...
            for t in n_topics:
                for p in n_passes:
                    ...
                    lda.save('./{}/{}_{}_{}_{}_{}'.format(save_path, product, t, p, tn, na))
...
def save_best(output, final_results, save_path):
    ...
    lda = gensim.models.ldamodel.LdaModel.load("./{}/{}_{}_{}_{}_{}".format(save_path, product, t, p, tn, na))
    lda.save('./{}/final_models/{}_{}_{}_{}_{}'.format(save_path, product, t, p, tn, na))
    lda.clear()
